...
************************************************************************
*
*                  Freescale MC9S12XEQ512 ISR Vector Definitions
*
...
extern void near  ADC1_ISR(void);
//extern void near  port_p_isr(void);

extern void near  CAN0_RX_ISR(void);
extern void near  CAN1_RX_ISR(void);
extern void near  CAN2_RX_ISR(void);
extern void near  CAN3_RX_ISR(void);
extern void near  CAN4_RX_ISR(void);
extern void near  PWM_ECT_ISR(void);
extern void near  TIMER_CH4_ISR(void);
extern void near  TIMER_CH0_ISR(void);
extern void near  TIMER_CH5_ISR(void);
extern void near  pwm_ect_overflow_isr(void);
extern void near  cp_pwm_isr(void);
extern void near  I2C0_ISR(void);
extern void near  I2C1_ISR(void);
extern void near  st1_pwm_isr(void);
extern void near  st3_pwm_isr(void);
extern void near  st5_pwm_isr(void);
extern void near  st7_pwm_isr(void);/*
************************************************************************
...
const tIsrFunc _vect[] @0x7F10 = {
        ...
        software_trapDE,//pwm_ect_overflow_isr, //software_trapDE,               /* 0xDE: Standard Timer Overflow                */

        software_trapE0,//st7_pwm_isr,//OSTickISR,                     /* 0xE0: Standard Timer Channel 7. Generally    */
                                       /* used for OS Tick interrupt and uC/Probe      */

        software_trapE2,//st5_pwm_isr,//software_trapE2,               /* 0xE2: Standard Timer Channel 6               */
        software_trapE4,//st3_pwm_isr,//TIMER_CH5_ISR,               /* 0xE4: Standard Timer Channel 5               */
        software_trapE6,//st1_pwm_isr,//TIMER_CH4_ISR,                /* 0xE6: Standard Timer Channel 4               */
        software_trapE8,               /* 0xE8: Standard Timer Channel 3               */        
        software_trapFA,//cp_pwm_isr, //PWM_ECT_ISR,               /* 0xEA: Standard Timer Channel 2               */
        software_trapEC,               /* 0xEC: Standard Timer Channel 1               */
        software_trapFE,               /* 0xEE: Standard Timer Channel 0               */ 
