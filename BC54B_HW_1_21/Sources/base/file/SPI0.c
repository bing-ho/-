...
********************************************************************************
*/ 
unsigned char SPI0_SendByte(unsigned char ubData) 
{
	unsigned int timeOut;
	timeOut = 0;      	
	SPI0DRL = ubData;
	while((!(SPI0SR_SPIF))  && (timeOut++ < 1000) );//等待数据接收完成 	    
	return SPI0DRL;  
}
