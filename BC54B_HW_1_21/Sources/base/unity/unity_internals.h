...
struct _Unity {
    const char *__FAR TestFile;
    const char *__FAR CurrentTestName;
...
void UnityBegin(const char *__FAR filename);
int  UnityEnd(void);
void UnityConcludeTest(void);
void UnityDefaultTestRun(UnityTestFunction Func, const char *__FAR FuncName, const int FuncLineNum);

//-------------------------------------------------------
// Test Output
//-------------------------------------------------------

void UnityPrint(const char *__FAR string);
...
void UnityAssertEqualIntArray(const void *__FAR expected,
...
void UnityAssertEqualString(const char *__FAR expected,
                            const char *__FAR actual,
                            const char *__FAR msg,
                            const UNITY_LINE_TYPE lineNumber);

void UnityAssertEqualStringLen(const char *__FAR expected,
                               const char *__FAR actual,
                               const _UU32 length,
                               const char *__FAR msg,
                               const UNITY_LINE_TYPE lineNumber);

void UnityAssertEqualStringArray( const char *__FAR *__FAR expected,
                                  const char *__FAR *__FAR actual,
                                  const _UU32 num_elements,
                                  const char *__FAR msg,
                                  const UNITY_LINE_TYPE lineNumber);

void UnityAssertEqualMemory( const void *__FAR expected,
                             const void *__FAR actual,
                             const _UU32 length,
                             const _UU32 num_elements,
                             const char *__FAR msg,
...
void UnityFail(const char *__FAR message, const UNITY_LINE_TYPE line);

void UnityIgnore(const char *__FAR message, const UNITY_LINE_TYPE line);
...
void UnityAssertEqualFloatArray(const _UF *__FAR expected,
                                const _UF *__FAR actual,
                                const _UU32 num_elements,
                                const char *__FAR msg,
                                const UNITY_LINE_TYPE lineNumber);
...
void UnityAssertEqualDoubleArray(const _UD *__FAR expected,
                                 const _UD *__FAR actual,
                                 const _UU32 num_elements,
                                 const char *__FAR msg,
                                 const UNITY_LINE_TYPE lineNumber);
...
#define UNITY_TEST_ASSERT_EQUAL_STRING(expected, actual, line, message)                          UnityAssertEqualString((const char* __FAR)(expected), (const char* __FAR)(actual), (message), (UNITY_LINE_TYPE)line)
#define UNITY_TEST_ASSERT_EQUAL_STRING_LEN(expected, actual, len, line, message)                 UnityAssertEqualStringLen((const char* __FAR)(expected), (const char* __FAR)(actual), (_UU32)(len), (message), (UNITY_LINE_TYPE)line)
#define UNITY_TEST_ASSERT_EQUAL_MEMORY(expected, actual, len, line, message)                     UnityAssertEqualMemory((void* __FAR)(expected), (void* __FAR)(actual), (_UU32)(len), 1, (message), (UNITY_LINE_TYPE)line)

#define UNITY_TEST_ASSERT_EQUAL_INT_ARRAY(expected, actual, num_elements, line, message)         UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT)
#define UNITY_TEST_ASSERT_EQUAL_INT8_ARRAY(expected, actual, num_elements, line, message)        UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT8)
#define UNITY_TEST_ASSERT_EQUAL_INT16_ARRAY(expected, actual, num_elements, line, message)       UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT16)
#define UNITY_TEST_ASSERT_EQUAL_INT32_ARRAY(expected, actual, num_elements, line, message)       UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT32)
#define UNITY_TEST_ASSERT_EQUAL_UINT_ARRAY(expected, actual, num_elements, line, message)        UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT)
#define UNITY_TEST_ASSERT_EQUAL_UINT8_ARRAY(expected, actual, num_elements, line, message)       UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_EQUAL_UINT16_ARRAY(expected, actual, num_elements, line, message)      UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_EQUAL_UINT32_ARRAY(expected, actual, num_elements, line, message)      UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT32)
#define UNITY_TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, actual, num_elements, line, message)        UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_HEX8)
#define UNITY_TEST_ASSERT_EQUAL_HEX16_ARRAY(expected, actual, num_elements, line, message)       UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_HEX16)
#define UNITY_TEST_ASSERT_EQUAL_HEX32_ARRAY(expected, actual, num_elements, line, message)       UnityAssertEqualIntArray((const void* __FAR)(expected), (const void* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_HEX32)
#define UNITY_TEST_ASSERT_EQUAL_PTR_ARRAY(expected, actual, num_elements, line, message)         UnityAssertEqualIntArray((const void* __FAR)(_UP* __FAR)(expected), (const void* __FAR)(_UP* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_POINTER)
#define UNITY_TEST_ASSERT_EQUAL_STRING_ARRAY(expected, actual, num_elements, line, message)      UnityAssertEqualStringArray((const char* __FAR* __FAR)(expected), (const char* __FAR* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line)
#define UNITY_TEST_ASSERT_EQUAL_MEMORY_ARRAY(expected, actual, len, num_elements, line, message) UnityAssertEqualMemory((void*__FAR)(expected), (void*__FAR)(actual), (_UU32)(len), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line)
...
#define UNITY_TEST_ASSERT_EQUAL_INT64_ARRAY(expected, actual, num_elements, line, message)       UnityAssertEqualIntArray((const _U_SINT* __FAR)(expected), (const _U_SINT* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT64)
#define UNITY_TEST_ASSERT_EQUAL_UINT64_ARRAY(expected, actual, num_elements, line, message)      UnityAssertEqualIntArray((const _U_SINT* __FAR)(expected), (const _U_SINT* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT64)
#define UNITY_TEST_ASSERT_EQUAL_HEX64_ARRAY(expected, actual, num_elements, line, message)       UnityAssertEqualIntArray((const _U_SINT* __FAR)(expected), (const _U_SINT* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_HEX64)
...
#define UNITY_TEST_ASSERT_EQUAL_FLOAT_ARRAY(expected, actual, num_elements, line, message)       UnityAssertEqualFloatArray((_UF* __FAR)(expected), (_UF* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line)
...
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE_ARRAY(expected, actual, num_elements, line, message)      UnityAssertEqualDoubleArray((_UD* __FAR)(expected), (_UD* __FAR)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line)
