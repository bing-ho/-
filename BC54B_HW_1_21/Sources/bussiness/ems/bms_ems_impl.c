...
OS_STK g_ems_ecu_tx_task_stack[ECU_TX_STK_SIZE] = { 0 };    //整车通信发送任务堆栈
OS_STK g_ems_ecu_rx_task_stack[ECU_RX_STK_SIZE] = { 0 };    //整车通信接收任务堆栈   
OS_STK g_ems_dbd_tx_task_stack[DBD_TX_STK_SIZE] = { 0 };    //仪表通信发送任务堆栈

#pragma DATA_SEG __RPAGE_SEG PAGED_RAM_EMS

EmsContext g_ems_context;   //缓冲区上下文

CanInfo g_ems_can_info;     //把ems_buffer的信息保存到g_ems_can_info
CanMessage g_ems_can_buffers[EMS_CAN_BUFFER_COUNT];   //在ems中报文的10个缓冲区

CanMessage g_ems_ecu_message;   //存储整车发送信息。
CanMessage g_ems_ecu_rx_message;   //存储整车接收信息。 
CanMessage g_ems_dbd_message;   //存储仪表发送信息。
#if( SWITCH_ON == UDS_SWITCH_CONFIG)
...
void ems_task_create(void)   //任务创建
{
...
/*****************************************************************************
 *函数名称:ems_get_chg_power_to_0_percent_flag
 *函数功能:获取充电降流至0的故障位
 *参    数:                                      
 *返 回 值:
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_get_chg_power_to_20_percent_flag
 *函数功能:获取充电降流至20%的故障位
 *参    数:                                      
 *返 回 值:
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_get_chg_power_to_50_percent_flag
 *函数功能:获取充电降流至50%的故障位
 *参    数:                                      
 *返 回 值:
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_get_dchg_power_to_0_percent_flag
 *函数功能:获取放电降流至0的故障位
 *参    数:                                      
 *返 回 值:
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_get_dchg_power_to_20_percent_flag
 *函数功能:获取放电降流至20的故障位
 *参    数:                                      
 *返 回 值:
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_get_dchg_power_to_50_percent_flag
 *函数功能:获取放电降流至50的故障位
 *参    数:                                      
 *返 回 值:
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_get_charger_continue_current
 *函数功能:获取最大可持续充电电流
 *参    数:                                      
 *返 回 值:最大可持续充电电流
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_discharge_continue_current_update
 *函数功能:获取最大可持续放电电流
 *参    数:                                      
 *返 回 值:最大可持续放电电流
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_charge_current_update
 *函数功能:获取最大短时充电电流
 *参    数:                                      
 *返 回 值:最大短时充电电电流
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_discharge_current_update
 *函数功能:获取最大短时放电电流
 *参    数:                                      
 *返 回 值:最大短时放电电流
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_chg_fault_level_update
 *函数功能:获取充电故障等级
 *参    数:                                      
 *返 回 值:充电故障等级
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_dchg_fault_level_update
 *函数功能:获取放电故障等级
 *参    数:                                      
 *返 回 值:放电故障等级
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_bms_alarm_level_update
 *函数功能:获取BMS故障等级
 *参    数:                                      
 *返 回 值:BMS故障等级
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_total_fault_num_update
 *函数功能:获取系统总故障数
 *参    数:                                      
 *返 回 值:系统总故障数
 *修订信息:
...
/*****************************************************************************
 *函数名称:ems_max_fault_level_update
 *函数功能:获取系统最高故障等级
 *参    数:                                      
 *返 回 值:系统最高故障等级
 *修订信息:
