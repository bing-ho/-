#ifndef _BMS_ERROR_H__
#define _BMS_ERROR_H__
...
#define ERR_NOTAVAIL                9               //寄存器的值或方法是无效的
...
#define ERR_PROTECT                 22              //保护规则违反标志
...
#define ERR_CLOCK_BASE              200
#define ERR_CLOCK_INVALID_VALUE     (ERR_CLOCK_BASE + 1)
#define ERR_CLOCK_INVALID_FLAG      (ERR_CLOCK_BASE + 2)
